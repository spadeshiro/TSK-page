...
## Installation
1. Extract downloaded `.zip` file to `Twinkle_StarknightsX` folder, replace files when asked. Zipped file is available through [Fanza English Discord](https://discord.gg/zEYhVM6) usually under `#twinkle_update` channel. <sub>(you'll need KuMaSan role in order to view the channel.)</sub>  
