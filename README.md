...
## Installation
1. Extract downloaded `.zip` file to `Twinkle_StarknightsX` folder, replace files when asked. Zipped file is available through our discord usually under `#twinkle_update` channel.  
